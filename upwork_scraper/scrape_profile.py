...
# extract and transform ranking data from the website
...
def main(ranking_base_url, firs_page, last_page):
    """
    ...
    for i in range(firs_page, last_page): # loop through the pages: e.g. 0, 100
        ...
        save_data(df, engine, table_name, subcategory) # save data to the database
        
        if i % 100 == 50: # prevent the overflow 
